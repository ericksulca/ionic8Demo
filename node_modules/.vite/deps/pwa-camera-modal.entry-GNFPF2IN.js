...
var __generator = function(e, t) {
  ...
  function c(s2) {
    ...
    while (a && (a = 0, s2[0] && (n = 0)), n)
      try {
        if (r = 1, i && (o = s2[0] & 2 ? i["return"] : s2[0] ? i["throw"] || ((o = i["return"]) && o.call(i), 0) : i.next) && !(o = o.call(i, s2[1])).done)
          return o;
        if (i = 0, o)
          s2 = [s2[0] & 2, o.value];
        switch (s2[0]) {
...
//# sourceMappingURL=pwa-camera-modal.entry-GNFPF2IN.js.map
